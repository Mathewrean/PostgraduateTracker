...
notification_mark_as_read = NotificationViewSet.as_view({'post': 'mark_as_read'})
notification_mark_all = NotificationViewSet.as_view({'post': 'mark_all_as_read'})
...
urlpatterns = [
    ...
    path('<int:pk>/mark_as_read/', notification_mark_as_read, name='notification-mark-as-read'),
    path('mark_all_as_read/', notification_mark_all, name='notification-mark-all'),
    path('unread_count/', notification_unread_count, name='notification-unread-count'),
]
